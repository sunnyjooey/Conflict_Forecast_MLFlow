...
# CHANGE ME
EXP_ID = "1723342686504342" # "test" experiment
...
space = {
  ...
  "learning_rate":  hp.choice('learning_rate', [0.0003, 0.0006, 0.001, 0.01, 0.1, 0.5])
  "max_depth": 0, # this is useful when data is small, not our case ,
  "min_child_weight": hp.choice('min_child_weight',[1, 5, 15, 200, 500]),
  "n_estimators": hp.choice('n_estimators', [5, 50,100, 500, 1000]),
  "n_jobs": -1, # was a 100 before
  "subsample": 0.2667800844454484, hp.choice('subsample',[0.01, 0.05, 0.1, 0.5, 0.8]),
  "verbosity": 0,
  "random_state": hp.choice('random_state', [7227536, 8009868,])},
}
